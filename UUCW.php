...
<html lang="en">
  <head>
    ...
    <meta name="description" content="USECSEPOINTS">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
             <li class="active"><a href="UUCW.php">Unadjusted UseCase Weight</a></li>
 	...
 	<div class="row">
		<div class="col-sm-6">
			...
			<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
				...
				<div class="form-group">
		          <label for="number"><b>Simple</b></label>
				...
				<div class="form-group">
					<label for="number"><b>Complex</b></label>
		...
		<h4>Result</h4>
			<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
				<div class="spd">
				<div class="form-group">
		          <label for="text"><b>Unadjusted Use Case Weight(uucw)</b></label>
		          <label for="text"><b>=(simple*5)+(Average*10)+(Complex*15)</b></label>
